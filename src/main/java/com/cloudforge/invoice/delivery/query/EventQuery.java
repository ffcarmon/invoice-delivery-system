package com.cloudforge.invoice.delivery.query;
...
public class EventQuery {
    ...
    public static final String SELECT_EVENTS_BY_USER_ID_QUERY =
            ...
            "FROM Events ev JOIN UserEvents uev ON ev.id = uev.event_id JOIN Users u ON u.id = uev.user_id " +
                    "WHERE u.id = :id ORDER BY uev.created_at DESC LIMIT 10";
